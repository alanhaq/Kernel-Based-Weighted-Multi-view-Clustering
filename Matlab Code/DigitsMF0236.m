...
% for subset MF0236. Similarly to SyntheticData.m, this caluclates the NMI
% for different p values for MVKKM and MVSpec, and compares our results to
% the ones from the paper.

load MF0236_rbf_kernel.mat;
...
NMI_MVKKM_paper = [0.915 0.95 0.945 0.942 0.942 0.942 0.935 0.935 0.935 0.93 0.93 0.93];
NMI_MVSpec_paper = [0.892 0.939 0.938 0.933 0.938 0.938 0.93 0.93 0.93 0.93 0.93 0.923];
