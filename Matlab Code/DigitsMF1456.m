...
% for subset MF1456. Similarly to SyntheticData.m, this caluclates the NMI
% for different p values for MVKKM and MVSpec, and compares our results to
% the ones from the paper.

load MF1456_rbf_kernel.mat;

K = MF1456_poly_kernel;
%gamma = 0.2;
...
NMI_MVKKM_paper = [0.762 0.768 0.755 0.755 0.755 0.755 0.755 0.755 0.755 0.755 0.755 0.758];
NMI_MVSpec_paper = [0.582 0.73 0.738 0.706 0.71 0.71 0.72 0.72 0.72 0.72 0.72 0.75];
